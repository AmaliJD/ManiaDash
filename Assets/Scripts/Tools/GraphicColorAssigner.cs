...
public class GraphicColorAssigner : ColorAssigner
{
    ...
    protected override void AssignColor(Color color, float hue, float sat, float val, float alpha)
    {
        ...
        else
        {
            ...
            {
                colorblock = GetComponent<Toggle>().colors;
            }
            
            switch(Button)
            {
                case 1: colorblock.normalColor = color; break;
                case 2: colorblock.highlightedColor = color; break;
                case 3: colorblock.pressedColor = color; break;
                case 4: colorblock.selectedColor = color; break;
                case 5: colorblock.disabledColor = color; break;
            }
            ...
            {
                GetComponent<Toggle>().colors = colorblock;
            }
        }
    }
}