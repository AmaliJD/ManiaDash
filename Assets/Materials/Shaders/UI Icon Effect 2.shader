Shader "Unlit/UI Icon Effect 2"
{
        ...
        SubShader
    {
        ...
        SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
        {
            ...
            float2 _PolarCoordinates_F22D9EBF_Out_4;
            Unity_PolarCoordinates_float(IN.uv0.xy, float2 (0.5, -0.44), 0.37, 1.21, _PolarCoordinates_F22D9EBF_Out_4);
            float _Voronoi_5110CF20_Out_3;
            float _Voronoi_5110CF20_Cells_4;
            Unity_Voronoi_float(_PolarCoordinates_F22D9EBF_Out_4, 43, 7.08, _Voronoi_5110CF20_Out_3, _Voronoi_5110CF20_Cells_4);
            float _Posterize_B3E83A1A_Out_2;
            Unity_Posterize_float(_Voronoi_5110CF20_Out_3, 4.89, _Posterize_B3E83A1A_Out_2);
            ...
            Unity_Blend_Multiply_float4((_Posterize_B3E83A1A_Out_2.xxxx), _SampleTexture2D_BB6E9D6C_RGBA_0, _Blend_41441713_Out_2, 1);
            float4 _Blend_14F7456B_Out_2;
            Unity_Blend_Multiply_float4(float4(-1, -1, -1, -0.9), _Blend_41441713_Out_2, _Blend_14F7456B_Out_2, 1);
